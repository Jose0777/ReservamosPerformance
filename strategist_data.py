question_strategist = [
    ...
    # {"id": 14, "category": "Desarrollo de Relaciones", "question": "Desarrolla relaciones de largo plazo si fuere el caso, con clientes, colaboradores externos y proveedores de confianza en beneficio de la empresa."},
